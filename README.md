...
|---|-------------|---------|------|
| 1 | **Data Augmentation** | Random Z-rotation (0–2π), Gaussian jitter (σ=0.01, clip ±0.05), random scaling (0.9–1.1) | `src/dataset_v2.py` |
...
| 4 | **Larger Spatial Blocks** | 20×20m blocks (stride 10m) with 4096–8192 points for broader spatial context | `src/dataset_v2.py` |
